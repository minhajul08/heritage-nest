        ...
        <div className="relative">
            <div className="max-w-[1440px] mx-auto w-full">
                ...
                <div className="absolute flex-col gap-9 inset-0 flex items-center justify-center">
                     <div className='max-w-[700px] mx-auto'><h1 className="text-white  text-center text-6xl font-bold">Your's Portal to India's Exquisite Real State</h1></div>
                    <p className='text-white'>Seamlossly connecting you to the heartbeat of india's propertise</p>
                    <button className='btn bg-blue-600 text-white flex items-center gap-2 border-none outline-none '><CiSearch />Find property</button>
                </div>
            </div>
        </div>
    );

        ...
        <div className="relative">
            <div className="max-w-[1440px] mx-auto w-full">
                ...
                <div className="absolute flex-col gap-9 inset-0 flex items-center justify-center">
                    ...
                    <Link to="/buy"> <button className='btn bg-blue-600 hover:bg-blue-600 text-white rounded flex items-center gap-2 border-none outline-none '><CiSearch />Find property</button></Link> 
                </div>
            </div>
        </div>
    );
